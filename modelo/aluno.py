...
class Aluno:
    ...
    def dadosUpdate(self):
        self.__dadosUpdate = "nome='{}',endereco='{}',nascimento='{}',cidade='{}',uf='{}',cep='{}' where idaluno={}".format(self.nome, self.endereco,self.nascimento,self.cidade,self.uf,self.cep,self.idaluno)
